...
<Note>
  Discover more templates at [cloudcoding.ai/templates](https://cloudcoding.ai/templates)
</Note>
...
<Card title="Explore Templates" icon="template" href="https://cloudcoding.ai/templates">
